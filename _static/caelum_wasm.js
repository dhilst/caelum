 ...
 * @returns {string}
 */
export function check_spec(source, opts_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.check_spec(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {string}
 */
export function check_spec_multi(files_json, root, opts_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.check_spec_multi(ptr0, len0, ptr1, len1, ptr2, len2);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 */
export function check_spec_z3(source, opts_json, solve_fn) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(opts_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.check_spec_z3(ptr0, len0, ptr1, len1, solve_fn);
    return ret;
}
